...
import { useDeleteExpense } from "@/features/vehicles/hooks/use-expenses";

/**
 * DeleteExpenseButton
 *
 * Client component that calls useDeleteExpense and invalidates the cache.
      ...
      <div className="mt-2 space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-2 rounded-lg border border-destructive/30 bg-destructive/5 px-3 py-2">
          <p className="flex-1 text-xs text-foreground">
            Delete <span className="font-semibold">{title}</span> expense?
          </p>
          <button
