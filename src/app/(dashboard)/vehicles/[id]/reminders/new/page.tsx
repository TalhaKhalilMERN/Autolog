...
import { useCreateReminder } from "@/features/vehicles/hooks/use-reminders";
...
export default function NewReminderPage({
  ...
  const isSubmitting = createReminderMutation.isPending;
  ...
  async function onSubmit(data: ReminderFormValues) {
    ...
    try {
      ...
      setServerError(err.message || "Failed to add reminder.");
    }
  }
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 shadow-elevated sm:p-8">
        <h2 className="text-xl font-semibold text-foreground">Add Reminder</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Set up a maintenance reminder for {vehicleName}.
        </p>
