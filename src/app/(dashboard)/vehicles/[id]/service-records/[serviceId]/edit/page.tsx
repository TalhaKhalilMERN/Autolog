...
import { useServiceRecord, useUpdateServiceRecord } from "@/features/vehicles/hooks/use-service-records";
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 shadow-elevated sm:p-8">
        <h2 className="text-xl font-semibold text-foreground">Edit Service Record</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="mt-6 space-y-5">
          ...
          <h3 className="text-sm font-semibold text-foreground">Next Service Reminder</h3>
...
export default function EditServiceRecordPage({
  ...
  const { data: record, isLoading: recordLoading, error: recordError } = useServiceRecord(serviceId);
  ...
  return <EditServiceForm vehicleId={vehicleId} vehicleName={vehicleName} record={record} />;
}
